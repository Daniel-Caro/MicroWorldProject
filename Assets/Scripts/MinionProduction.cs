        ...
        if(sumacolasmasacumulado < capacityExtra+Globals.minionCapacity){
            if (producing == true ){
                ...
                if(Globals.colaFactoria[building.GetInstanceID()].Count> 0){
                    ...
                    else if (miniontoproduce == 2 && Globals.buildingLevelsDic[building.GetInstanceID()] >= 4){
                    ...
                    else if (miniontoproduce== 3 && Globals.buildingLevelsDic[building.GetInstanceID()] >= 7){
                        producing = true;
                    ...
                    else if (miniontoproduce == 4 && Globals.buildingLevelsDic[building.GetInstanceID()] >= 10){
                    ...
                    else if (text.Equals("Tier2") && Globals.buildingLevelsDic[building.GetInstanceID()] >= 4){
                    ...
                    else if (text.Equals("Tier3") && Globals.buildingLevelsDic[building.GetInstanceID()] >= 7){
                        producing = true;
                    ...
                    else if (text.Equals("Tier4") && Globals.buildingLevelsDic[building.GetInstanceID()] >= 10){
